...
namespace ArenaOIA.Controllers
{
    ...
    public class ContestsController : Controller
    {
        ...
        public ActionResult Edit(Contest contest)
        {
            ...
            if (ModelState.IsValid)
            {
                Contest viejo = firebase.GetContest(contest.Id);
                contest.Participantes = viejo.Participantes;
        ...
        public PartialViewResult BlankEditorRow(int idAnterior)
        {
